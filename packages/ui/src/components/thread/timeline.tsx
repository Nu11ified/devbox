...
export interface TimelineItem {
  id: string;
  kind: "user_message" | "assistant_text" | "work_item" | "approval_request" | "error" | "todo_progress" | "ask_user" | "context_compacted" | "tool_group" | "phase_transition" | "gate_result" | "cycle_summary";
  content?: string;
  streaming?: boolean;
  toolName?: string;
  toolCategory?: string;
